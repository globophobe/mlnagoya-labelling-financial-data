...
# The *cusum_filter* is described as an "[improvement] over popular market signals such as Bollinger bands, as it resets at each sample.
...
# Basically, the result of a primary model becomes input for a secondary model.
...
# ...ML should be used [primarily] as a research tool, and not as a forecasting tool.
