...
# Lopez de Prado also suggests "meta-labelling".
## 「メタラベル」て言う事はも勧められています。

---

# Basically, the result of the primary model becomes input for a secondary model.
...
def true_meta_labels(y_pred, y_test):
    """Labels were 0, 1, -1. Encode correctly predicted labels of 1 or -1 as true positive."""
...
# 859 false positives, 0 false negatives.
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableItem><strong>0.51</strong></TableItem>
      <TableItem><strong>0.68</strong></TableItem>
      <TableItem>1752</TableItem>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableItem />
      <TableItem />
      <TableItem><strong>0.60</strong></TableItem>
    ...
    <TableRow>
      ...
      <TableItem><strong>0.58</strong></TableItem>
      <TableItem>2148</TableItem>
    </TableRow>
    <TableRow>
      <TableItem>weighted avg</TableItem>
      <TableItem>0.87</TableItem>
      <TableItem>0.60</TableItem>
      <TableItem><strong>0.64</strong></TableItem>
      <TableItem>2148</TableItem>
    </TableRow>
  </TableBody>
</Table>
...
```python
sm = SMOTE()
x_train_meta_res, y_train_meta_res = sm.fit_sample(
    x_train_meta, y_train_meta
)
secondary_model = LogisticRegression().fit(
    x_train_meta_r, y_train_meta_res
  )
...
# Now, 472 false positives, 132 false negatives.
...
# Intuitively, it is preferable to do nothing (False Negative)... 

---

# ...than be exposed to a loss (False Positive).

---

# Significantly, the primary model could be anything, an ML model, a fundamental model...


---

# ...or even a monkey deciding trades by throwing darts.
